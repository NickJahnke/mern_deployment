...
const Update = ({id, updatePirate}) =>{
    ...
    useEffect(() =>{
        axios.get(`http://localhost:9000/pirates/${id}`)
            .then(res=>{
                console.log(res);
    ...
    axios.put(`http://localhost:9000/pirates/${id}`, /*add other properties*/{name:name, url:url, treasureChests: treasureChests,phrase: phrase,position: position, pegLeg: pegLeg, eyePatch:eyePatch,hookHand:hookHand})
    .then(res=>{
        console.log(res);
